...
class Bid(models.Model):
    ...
    item = models.ForeignKey(Auction_item, related_name="bids", on_delete=models.CASCADE)
...
class Comment(models.Model):
    ...
    item = models.ForeignKey(Auction_item, related_name="comment", on_delete=models.CASCADE)
...
class Notification(models.Model):
    ...
    text = models.CharField(max_length=64)
    item = models.ForeignKey(Auction_item, related_name="item", on_delete=models.CASCADE)
